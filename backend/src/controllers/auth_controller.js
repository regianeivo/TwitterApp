...
function getHandlers(AUTH_SECRET, userRepository) {
    var _this = this;
    // Returns a JWT when the user credentials are valid
    var login = function (req, res) {
        (function () { return __awaiter(_this, void 0, void 0, function () {
            var userDetails, result, user, tokenContent, token, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
                        userDetails = req.body;
                        result = joi.validate(userDetails, user_controller_1.userDetailsSchema);
                    ...
                    case 2:
                        ...
                        if (user === undefined) {
                            ...
                            if (AUTH_SECRET === undefined) {
                                ...
                                tokenContent = { id: user.id };
                                token = jsonwebtoken_1.default.sign(tokenContent, AUTH_SECRET);
...
function getAuthController() {
    ...
    var handlers = getHandlers(AUTH_SECRET, repository);
